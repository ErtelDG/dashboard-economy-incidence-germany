...
store.state.indicatore = {
   ...
   laggingIndicators: {
      ...
      description:
         "Spätindikatoren dienen dazu, die konjunkturelle Entwicklung im Nachhinein zu erklären oder zu beschreiben. Einer der wichtigsten indicatoren in diesem Bereich ist die Entwicklung der Arbeitslosenzahlen",
      example: [
         {
...
store.state.economicDecision = {
   p1: {
      headline: "Weshalb sind Konjunkturindicatoren von Bedeutung?",
      paragraphs: [
   ...
   p2: {
      ...
      paragraphs: [
         ...
         "Daher berechnen sowohl das Statistische Bundesamt als auch Wirtschaftsforschungsinstitute regelmäßig indicatoren, die es den Interessengruppen ermöglichen, die wirtschaftliche Lage schnell zu überblicken und präzise einzuschätzen. Damit diese indicatoren eine hohe Aussagekraft besitzen, werden sie in möglichst kurzen Zeitabständen erhoben, in der Regel quartalsweise oder monatlich.",
         "Um langfristige Vergleiche zu ermöglichen und den Zahlen mehr Aussagekraft zu verleihen, müssen die indicatoren als sogenannte „lange Reihen“ vorliegen, das heißt, sie müssen über mehrere Jahre hinweg erfasst und ausgewertet werden. Nur so lässt sich die konjunkturelle Entwicklung mit ihren verschiedenen Phasen in Form einer Konjunkturkurve darstellen.",
   ...
   p3: {
      headline: "Chronologische Einteilung der Konjunkturindicatoren",
      paragraphs: [
         "Konjunkturindicatoren sind Kennzahlen, die dazu dienen, die Entwicklung einer Volkswirtschaft über einen bestimmten Zeitraum hinweg abzubilden oder zu beschreiben. Sie liefern wichtige Zahlenwerte und Vergleichsreihen für die Prognose, description und Analyse der Konjunktur.",
         "Konjunkturindicatoren können vor, während und nach einem bestimmten Ereignis oder einer Konjunkturphase erfasst werden.",
      ],
   },
};
